...
{{--
            ...
            <div class="checkout-table-container">
                    ...
                    @foreach ($carts as $item)
                        <div class="checkout-table-row">
                            <div class="checkout-table-row-left">
                                <img src="{{ checkFileExist($item->model->image) }}" alt="item" class="checkout-table-img">
                                <div class="checkout-item-details">
                                    <div class="checkout-table-item">{{ $item->model->name }}</div>
                                    <div class="checkout-table-description">{{ $item->model->details }}</div>
                                    <div class="checkout-table-price">{{ changePriceFormat($item->subtotal) }}</div>
                                </div>
                ...
                <div class="checkout-totals">
                    ...
                    {{ changePriceFormat($newTax) }} <br>
                        <span class="checkout-totals-total">{{ changePriceFormat($newTotal) }}</span>
   ...
   <script>
       (function(){
           ...
           var stripe = Stripe('pk_test_9qS9QThP1fOOikIbjqTaOtI2');
